...
png('figs/support-a.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-b.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-c.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-d.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-f.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-i.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-k.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-o.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-v.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-oe.png', width = 642, height = 367.7, units = "px", res = 110)
...
png('figs/support-aa.png', width = 642, height = 367.7, units = "px", res = 110)
